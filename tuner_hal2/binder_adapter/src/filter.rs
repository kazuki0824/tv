...
impl FilterCommand {
    pub fn plan(&self) -> CommandPlan {
        match self {
            ...
            Self::ConfigureAvStreamType(_) => CommandPlan {
                object: AidlObjectKind::Filter,
