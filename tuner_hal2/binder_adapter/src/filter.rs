...
impl FilterCommand {
    pub(super) fn plan(&self) -> Result<CommandPlan, HalError> {
        match self {
            ...
            Self::ConfigureAvStreamType(_) => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterConfigureAvStreamType)
            }
            Self::GetQueueDesc => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterGetQueueDesc)
            }
            Self::GetId => CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterGetId),
            Self::GetId64Bit => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterGetId64Bit)
            }
            Self::GetAvSharedHandle => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterGetAvSharedHandle)
            }
            Self::ReleaseAvHandle(_) => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterReleaseAvHandle)
            }
            ...
            Self::SetDataSource(_) => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterSetDataSource)
            }
            Self::SetDelayHint(_) => {
                CommandPlan::for_api(AidlObjectKind::Filter, AidlApi::FilterSetDelayHint)
            }
        }
    }
}
