...
def resolve_region(profile: dict[str, Any], dataset: dict[str, Any], select_index: int | None = None) -> None:
    ...
    for index, raw in enumerate(entries):
        ...
        matches.append({
            ...
            "frequency_hz": positive_int(entry.get("frequency_hz"), f"dataset.entries[{index}].frequency_hz"),
