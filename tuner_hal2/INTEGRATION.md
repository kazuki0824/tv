...
`TableInfo repeat=false`を含むsection filterの公開意味、first-instance解決、停止条件、`repeat=true`との使い分けは`../tuner_hal/DESIGN_JA.md`を正とする。複数table instanceの収集・完成管理とTISからの`stop()`判断は`../tis/DESIGN_JA.md`および`../arib_si_engine_rs/DESIGN_JA.md`を正とする。
