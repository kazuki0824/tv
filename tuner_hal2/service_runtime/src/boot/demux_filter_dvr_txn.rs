use super::{
    ...
    DvrKind, DvrOpenKind, DvrRuntime, DvrRuntimeId, FilterAvStreamKind,
    FilterAvStreamTypeRequest, FilterConfig, FilterConfigureTxn, FilterDelayHint,
    FilterDelayHintKind, FilterDelayHintRequest, FilterOpenType, FilterRuntime,
...
impl TunerServiceRuntime {
    ...
    fn transact_unregister_dvr_runtime(&mut self, id: i32) -> Option<crate::registry::DvrRegistryEntry> {
...
impl<'a> DemuxFilterDvrTxn<'a> {
    ...
    pub(crate) fn allocate_filter_runtime(
        ...
        self.runtime.transact_allocate_filter_runtime(owner_demux_id)
    }
    ...
    pub(crate) fn set_filter_delay_hint_request(
        ...
        self.runtime.transact_set_filter_delay_hint_request(filter_id, request)
    }
    ...
    pub(crate) fn set_filter_data_source_non_null(
        ...
        self.runtime
            .transact_set_filter_data_source_non_null(demux_id, sink_filter_id, source_filter_id)
    }
    ...
    pub(crate) fn unregister_dvr_runtime(&mut self, id: i32) -> Option<crate::registry::DvrRegistryEntry> {
    ...
    pub(crate) fn register_demux_dvr_runtime(
        ...
        self.runtime
            .transact_register_demux_dvr_runtime(owner_demux_id, dvr_id, request, callback_present)
    }
}
