...
pub const SERVICE_RUNTIME_DISPATCH_TABLE: &[RuntimeDispatchEntry] = &[
    ...
    RuntimeDispatchEntry {
        ...
        target: ServiceRuntimeDispatchTarget::Filter,
    },
    RuntimeDispatchEntry {
    ...
    RuntimeDispatchEntry {
        ...
        target: ServiceRuntimeDispatchTarget::Dvr,
    },
    RuntimeDispatchEntry {
    ...
    RuntimeDispatchEntry {
        ...
        target: ServiceRuntimeDispatchTarget::Descrambler,
    },
    RuntimeDispatchEntry {
    ...
    RuntimeDispatchEntry {
        ...
        target: ServiceRuntimeDispatchTarget::Lnb,
    },
    RuntimeDispatchEntry {
