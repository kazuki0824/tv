...
use maleicacid_tuner_hal2_device::{
    ...
    FrontendRuntimeSnapshot, FrontendWorkerCancelReason, FrontendWorkerContext, FrontendWorkerKind,
...
fn record_scan_cancelled_terminal_event(
    ...
    lock_runtime(runtime, "service runtime lock poisoned")?.cancel_frontend_scan_session(
        frontend_id,
        generation,
        reason,
    )
