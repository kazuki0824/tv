...
class PlaybackPipeline(
    ...
    private object EsHeaderParser {
        ...
        private class BitReader(private val bytes: ByteArray) {
            ...
            fun skipBits(count: Int) { repeat(count) { readBit() } }
