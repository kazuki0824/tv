...
object CasControllerStateTestVectors {
    ...
    fun pluginSelectionSuccessMetadata(): List<CaMetadata> =
        listOf(
            CaMetadata(
                serviceKey,
    ...
    fun unsupportedSystemIdMetadata(): List<CaMetadata> =
        listOf(
            CaMetadata(
                serviceKey,
                0x7fff,
    ...
    fun pmtUpdateRemovesOldPidMetadata(): Pair<List<CaMetadata>, List<CaMetadata>> =
        Pair(
            listOf(
                CaMetadata(
                    serviceKey,
