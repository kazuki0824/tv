...
internal fun testCasFacts(requiresCas: Boolean = false): String = if (requiresCas) {
    """{"pmtPid":256,"parseStatus":"OK","sdtFreeCaMode":true,"descriptors":[{"scope":"PROGRAM","esPid":null,"caSystemId":5,"caPid":512,"rawDescriptorHex":"09040005e200"}]}"""
} else {
