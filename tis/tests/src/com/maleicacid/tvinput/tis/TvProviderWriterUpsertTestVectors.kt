...
object TvProviderWriterUpsertTestVectors {
    ...
    val invalidChannel = ChannelRecord(ServiceKey(originalNetworkId = -1, transportStreamId = 16625, serviceId = 101), displayNumber = "101", displayName = "invalid", frequencyHz = 473_142_857L)
}
