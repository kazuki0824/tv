        ...
        val scheduler =
            BroadcastTimedPesScheduler(
                resolveDeadline = { _, expectedGeneration ->
                    if (expectedGeneration != null && expectedGeneration != clockGeneration) {
                        null
                    } else {
                        AribBroadcastClock.Deadline(clockGeneration, delayMillis)
                    }
                },
            ...
            BroadcastTimedPesScheduler(
                resolveDeadline = { _, expectedGeneration ->
                    if (expectedGeneration != null && expectedGeneration != clockGeneration) {
                        ...
                        AribBroadcastClock.Deadline(clockGeneration, 1_000L)
                    }
                },
