    ...
    @Test fun oneShotPacketPreservesRgbaMetadataAndTiming() {
        ...
        check(
            frame.images
                .single()
                .rgba8888
                .contentEquals(byteArrayOf(0x11, 0x22, 0x33, 0x44)),
        )
    }
